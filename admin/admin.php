	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(picsystem/ad3.jpg)"></div>
					<div class="home_slider_content">
						<div class="container">
							
								<div class="col text-center">
									<div class="home_slider_title">School Results Management System</div>
							...
							<input type="text" class="counter_input" name = "name" placeholder="name" required>
							<input type="password" class="counter_input" name ="password" placeholder="password" >
							
								<button type="submit" value ="submit" name ="login" value = "login"class="counter_form_button">LOGIN</button>
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(images/counter_background.jpg)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
