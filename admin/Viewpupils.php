...
<div class="super_container">
	...
	<div class="contact_info_container">
		<div class="container">
			<div class="row">
				<h2> ViewAllPupuils</h2>

<p>Staff only  </p>
				<!-- Contact Form -->
				<form action="#" class="comment_form" style="margin:350px;">
			...
			<section class='row'>
				...
				<div class='col-md-2 col-sm-2 side_nav noprint'>
					<ul class="nav nav-pills nav-stacked">
						...
						<li role="presentation"><a href="staff_dashboard.php?administratives"><span class='glyphicon glyphicon-tasks'></span> Admini</a></li>
								...
								if(isset($_POST['admin_upload_btn'])){
									...
									elseif(empty($school_motto)){
										...
										$query = " INSERT INTO `administratives`(`school_name`, `school_motto`, `school_logo`, `school_stamp`, `upload_date`)
													VALUES('".mysqli_real_escape_string($connection,$school_name)."', '".mysqli_real_escape_string($connection,$school_motto)."', '{$image_location}', '{$image_location1}', '{$date}') ";
										$run_query = mysqli_query($connection, $query);
										if($run_query == true){
								...
								if(isset($_POST['add_class_btn'])){
									...
									if(empty($add_class)){
										...
										if(mysqli_num_rows($run_query) > 0){
											...
											$query = " INSERT INTO `classes`(`classes`, `date_added`) VALUES('".mysqli_real_escape_string($connection,$add_class)."', '$date') ";
											$run_query = mysqli_query($connection, $query);
						...
						echo"
							...
							<div class='col-md-10' id='log'>
								<div class='panel panel-primary'>
									...
									<div class='panel-body'>
										<form class='' id='login' method='POST' action='staff_dashboard.php?check_result'>
											<div class='input-group'>
												<span class='input-group-addon' id='basic-addon2'>REG NO</span>
