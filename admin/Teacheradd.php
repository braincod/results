...
<li role="presentation"><a href="index.php?register_new_student"><span class='glyphicon glyphicon-education'></span> Register New Student</a></li>
	<!-- Contact -->
	<div class="contact_info_container">
		<div class="container">
			<div class="row">
				<h2> Teacher Enrollement</h2>
							...
							require_once("staff_dashboard_processor.php");
								...
								<div class='panel panel-primary'>
									<div class='panel-heading'>
										<h3 class='text-center'>Register New Teacher</h3>
									</div>
