...
<div class="super_container">
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Next Grade </h2>
	...
	<div class="counter">
		<div class="counter_background" style="background-image:url(picsystem/three-ways-tw.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
				...
				<div class="row fill_height">
					<div class="col fill_height">
						<form class="counter_form_content d-flex flex-column align-items-center justify-content-center" action="#">
							<div class="counter_form_title">promote student </div>
							<input type="text" class="counter_input" name = "promote_from" placeholder="promote_from" required="required">
							<input type="text" class="counter_input" name = "promote_to" placeholder="promote_to" required="required">
